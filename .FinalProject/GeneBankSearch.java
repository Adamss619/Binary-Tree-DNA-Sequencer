...
public class GeneBankSearch {
    ...
    private void printUsage(String error) {
        ...
        System.out.println(
                "<0/1 (no/with Cache)>: 	A 0  cache, 1 declares a cache");
        System.out.println("			 If a cache declared, the 4th argument must be a positive integer");
        System.out.println("<btree file>: 		File where tree is stored");
        System.out.println("<query file>:		The query used to compare to tree");
        System.out.println(
